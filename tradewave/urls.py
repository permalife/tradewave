...
urlpatterns = [
    ...
    url(r'^create-vendor/(?P<invite_token>\w{8}-\w{4}-\w{4}-\w{4}-\w{12})$', views.CreateVendor.as_view(), name='create-vendor'),
    url(r'^create-vendor/(?P<invite_token>\w{8}-\w{4}-\w{4}-\w{4}-\w{12})/(?P<status_msg>.*)/$', views.CreateVendor.as_view(), name='create-vendor'),
    url(r'^dashboard/$', views.DashboardView.as_view(), name='dashboard'),
    url(r'^entity-invite-or-assign-users/$', views.EntityInviteOrAssignUsers.as_view(), name='entity-invite-or-assign-users'),
    url(r'^marketplace-initial/$', views.MarketplaceInitial.as_view(), name='marketplace-initial'),
    url(r'^marketplace-invite-vendors/$', views.MarketplaceInviteVendors.as_view(), name='marketplace-invite-vendors'),
    ...
    url(r'^marketplace-issue-login/(?P<status_msg>.*)/$', views.MarketplaceIssueLogin.as_view(), name='marketplace-issue-login'),
    ...
    url(r'^create_vendor/(?P<token>\w{8}-\w{4}-\w{4}-\w{4}-\w{12})$', views.create_vendor, name='create_vendor'),
    url(r'^entity_invite_or_assign_users/(?P<entity_id>\d+)/(?P<is_vendor>(True|False))$', views.entity_invite_or_assign_users, name='entity_invite_or_assign_users'),
