...
(function($){
    ...
    $.WebcamQRCode.defaultOptions = {
    	messageNoFlash:		'<p class="style1"> Flash animation is not activated </p>',
        onQRCodeDecode: 	function( p_data ){ alert( "onQRCodeDecode data: " + p_data ); },
        onError:			function( p_e ){ alert( p_e ); },
        webcamOnStart:		false,
        webcamStopContent:	$('<p class="style1">Login or press the button to activate the card reader</p>'),
        delay:				5000,
        path:				"/static"
    };
    ...
    _flash.attr( 'align', "middle" );
    _flash.attr( 'vspace', "0px" );
